...
private static final DTOMapper<CorreoElectronicoClienteDTO, CorreoElectronicoClienteDomain> instancia = new CorreoElectronicoClienteDTOMapper();
	...
	public static final CorreoElectronicoClienteDomain convertirToDomain(final CorreoElectronicoClienteDTO dto) {
		return instancia.toDomain(dto);
	}
	
	public static final CorreoElectronicoClienteDTO convertirToDTO(final CorreoElectronicoClienteDomain domain) {
